...
WEIGHTS = {
    "buffett_moat":           20,
    "buffett_valuation":      15,
    "weiss_yield":             8,
    "weiss_quality":           8,
    "bogle_timing":            8,
    "bogle_diversification":   8,
    "dalio_debt":              8,
    "dalio_bubble":            8,
    "lynch_peg":               7,
    "druckenmiller":          10,   # triple alignment: macro+momentum+technicals
}
...
def build_composite(
    ...
    def maybe_add(key, name, base_weight, raw_fn, *args):
        ...
        try:
            ...
            # Scorer crashed — use neutral 0.5 so it doesn't zero other scores
            raw, display, detail = 0.5, f"Error: {e}", ""
